...
edhec_lille = Group.create!(name: 'Edhec Lille', description: "Groupe des étudiants de l'Edhec Grande Ecole et Msc, pour plus de fun et de sport !", email_domain_name: 'edhec.com')
edhec_nice = Group.create!(name: 'Edhec Nice', description: "Groupe des étudiants de l'Edhec Grande Ecole et Msc, pour plus de fun et de sport !", email_domain_name: 'edhec.com')
...
User.create!(name: "Arthur Mathias", group: edhec_nice, phone_number: '0675657374', age: 22, crew: "Chti", email: "arthur.mathias@edhec.com", password: 'kikoulol')
...
patrick = User.create!(name: "Patrick Sebastien", group: edhec_nice, phone_number: '0675245374', age: 21, crew: "Musicall", email: "patrick.sebastien@edhec.com", password: 'kikoulol')
